        ...
        protected override void Seed(MyTinyCollege.DAL.SchoolContext context)
        {
            ...
            var instructors = new List<Instructor>
            {
                new Instructor {
                    FirstName ="Denis",
                    LastName="Cormier",
                    HireDate=DateTime.Parse("2003-08-01"),
                    Email="dbcormier@tinycollege.com"},
                new Instructor {
                    FirstName ="Marc",
                    LastName="Williams",
                    HireDate=DateTime.Parse("2003-08-01"),
            ...
            var departments = new List<Department>
            {
                ...
                new Department {Name="Literature", Budget=150000, StartDate=DateTime.Parse("2010-09-01"), InstructorID=2}
            };
            ...
            var enrollments = new List<Enrollment>
            {
                ...
                new Enrollment {StudentID =3, CourseID=3141, Grade=Grade.B},
